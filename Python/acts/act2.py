import collections
texto = """INumPy is the fundamental package for scientific computing with Python.
...
#2
sin_repetir = texto.lower().split()
c = collections.Counter(sin_repetir)
...
char = "i"
print(texto.lower().split()[0].startswith(char))
